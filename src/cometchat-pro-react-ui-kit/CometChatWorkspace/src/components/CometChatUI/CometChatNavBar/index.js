...
class CometChatNavBar extends React.Component {
	...
	signOut = () => {
		console.log('sign out functions');
		...
		return (
			<React.Fragment>
				...
				<div css={footerStyle()} className="sidebar__footer">
					...
					<div css={signoutwraper()} >
						<button css={signoutBtnStyle()}  type="button" onClick={this.props.onLogout}>Sign Out</button>
					</div>
				</div>
			</React.Fragment>
		);
...
export default connect( mapStateToProps, mapDispatchToProps )( CometChatNavBar );
